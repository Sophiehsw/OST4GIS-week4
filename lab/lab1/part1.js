...
var query6 = _.sortBy(bakedGoods, function(i) {return Math.sin(i.inventory)});
...
var query7 = _.groupBy(bakedGoods, function(i) {return i.type});
...
// printMenu(query7);
var printMenu = function(foodList) {
  _.each(bakedGoods, function(food) {
    console.log(food.name + ' ... $' + food.price);
  });
};
printMenu(query7);
